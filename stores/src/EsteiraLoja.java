...
class EsteiraLoja {
  ...
  public EsteiraLoja(int tamanho, FileWriter logFile) {
  ...
  public void estocarVeiculo(Veiculo veiculo) throws InterruptedException {
      ...
      try {
        log("[ESTEIRA]  - Veículo foi adicionado na esteira da loja" + " na posição " + this.entrada + " (ID: " + veiculo.getId() + ", Cor: " + veiculo.getCor() +
  ...
  public Veiculo retirarVeiculoDaEsteira() throws InterruptedException {
      ...
      try {
          log("[VENDA]    - Veículo retirado da esteira da loja: " + "(ID: " + veiculo.getId() + ", Cor: " + veiculo.getCor() +
          ", Tipo: " + veiculo.getTipo() + ", Estação: " + veiculo.getEstacaoId() +
          ", Funcionário: " + veiculo.getFuncionarioId() + ")");
      } catch (IOException e) {
          e.printStackTrace();
